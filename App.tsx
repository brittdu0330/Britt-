...
// Component defined outside to prevent re-mounting on every state change
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <button 
                    ...
                    title="Save profile details to this browser"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    placeholder="Paste your resume content, key projects, or achievements..."
                    className="w-full h-48 md:h-56 p-5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-400 outline-none transition-all resize-none text-gray-700 leading-relaxed"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="p-8 lg:p-12 space-y-8">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <InputField 
                    icon={Building} 
                    label="Company or Recipient" 
                    value={companyName} 
                    onChange={setCompanyName} 
                    placeholder="e.g. Google or Hiring Manager" 
                  />
                  <InputField 
                    icon={Target} 
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full h-48 md:h-56 p-5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-purple-100 focus:border-purple-400 outline-none transition-all resize-none text-gray-700 leading-relaxed"
                  />
                </div>
              </div>
            </div>
                ...
                {result && !isGenerating && (
                  <div className="flex items-center space-x-3 flex-wrap">
                    <button
                      onClick={handleGenerate}
                      disabled={isGenerating}
                      className="flex items-center space-x-2 px-4 py-2 rounded-xl border border-blue-100 bg-blue-50/50 text-blue-600 hover:bg-blue-50 transition-all active:scale-95"
                    >
                    ...
                    <button
                      onClick={handleCopy}
                      className="flex items-center space-x-2 px-4 py-2 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-blue-500 transition-all active:bg-blue-50"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-2 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-blue-500 transition-all"
                    >
                ...
                {isGenerating ? (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="h-4 bg-gray-100 rounded w-5/6 shimmer" />
                      <div className="h-4 bg-gray-100 rounded w-4/6 shimmer" />
                    </div>
                  </div>
                ) : (
                  <div className="prose prose-blue max-w-none text-gray-700 whitespace-pre-wrap leading-relaxed text-lg font-light">
                    {result}
                  </div>
                )}
              </div>
